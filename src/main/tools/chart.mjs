...
stacked_column/stacked_bar = แท่งซ้อน ใช้เมื่อแต่ละก้อนแบ่งย่อยได้และอยากเห็นทั้งยอดรวมและส่วนประกอบพร้อมกัน
  เช่น ผู้ป่วยนอกรายเดือนแยกตามสิทธิ, ผู้ป่วยแต่ละแผนกแยกตามเพศ — ต้อง SELECT ตั้งแต่ 3 คอลัมน์ขึ้นไป (ป้าย + ชุดย่อยอย่างน้อย 2)
  stacked_column ซ้อนแนวตั้ง ใช้เมื่อป้ายสั้นและไม่เกิน 10 อัน (เดือน, ปี, เพศ)
  stacked_bar ซ้อนแนวนอน ใช้เมื่อป้ายยาวหรือเยอะ (ชื่อแผนก ชื่อโรค ชื่อตำบล) แนวตั้งจะถูกหมุนเฉียงจนอ่านไม่ออก
